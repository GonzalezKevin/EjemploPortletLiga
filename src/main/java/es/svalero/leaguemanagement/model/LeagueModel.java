...
/**
 * The base model interface for the League service. Represents a row in the &quot;LM_League&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link es.svalero.leaguemanagement.model.impl.LeagueModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link es.svalero.leaguemanagement.model.impl.LeagueImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see League
 * @see es.svalero.leaguemanagement.model.impl.LeagueImpl
 * @see es.svalero.leaguemanagement.model.impl.LeagueModelImpl
 * @generated
 */
public interface LeagueModel extends BaseModel<League>, StagedGroupedModel {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. All methods that expect a league model instance should use the {@link League} interface instead.
     */
    ...
    @Override
    public CacheModel<es.svalero.leaguemanagement.model.League> toCacheModel();
