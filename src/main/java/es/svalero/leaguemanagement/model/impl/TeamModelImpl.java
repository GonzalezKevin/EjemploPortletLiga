...
import es.svalero.leaguemanagement.model.TeamModel;
import es.svalero.leaguemanagement.model.TeamSoap;
...
/**
 * The base model implementation for the Team service. Represents a row in the &quot;LM_Team&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link es.svalero.leaguemanagement.model.TeamModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TeamImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see TeamImpl
 * @see es.svalero.leaguemanagement.model.Team
 * @see es.svalero.leaguemanagement.model.TeamModel
 * @generated
 */
@JSON(strict = true)
public class TeamModelImpl extends BaseModelImpl<Team> implements TeamModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a team model instance should use the {@link es.svalero.leaguemanagement.model.Team} interface instead.
     */
    public static final String TABLE_NAME = "LM_Team";
    ...
    public static final String TABLE_SQL_CREATE = "create table LM_Team (uuid_ VARCHAR(75) null,teamId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,leagueId LONG,name VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table LM_Team";
    public static final String ORDER_BY_JPQL = " ORDER BY team.teamId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY LM_Team.teamId ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.es.svalero.leaguemanagement.model.Team"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.es.svalero.leaguemanagement.model.Team"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.es.svalero.leaguemanagement.model.Team"),
            true);
    public static long COMPANYID_COLUMN_BITMASK = 1L;
    public static long GROUPID_COLUMN_BITMASK = 2L;
    public static long LEAGUEID_COLUMN_BITMASK = 4L;
    public static long UUID_COLUMN_BITMASK = 8L;
    public static long TEAMID_COLUMN_BITMASK = 16L;
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.es.svalero.leaguemanagement.model.Team"));
    ...
    public Object clone() {
        ...
        teamImpl.setLeagueId(getLeagueId());
    ...
    public void resetOriginalValues() {
        ...
        teamModelImpl._originalLeagueId = teamModelImpl._leagueId;

        teamModelImpl._setOriginalLeagueId = false;
    ...
    public CacheModel<Team> toCacheModel() {
        ...
        teamCacheModel.leagueId = getLeagueId();
