...
/**
 * Provides the local service interface for LeagueDay. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LeagueDayLocalServiceUtil
...
public interface LeagueDayLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link LeagueDayLocalServiceUtil} to access the league day local service. Add custom service methods to {@link es.svalero.leaguemanagement.service.impl.LeagueDayLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
