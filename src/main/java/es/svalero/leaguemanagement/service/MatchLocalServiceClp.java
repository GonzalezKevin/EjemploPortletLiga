...
public class MatchLocalServiceClp implements MatchLocalService {
    ...
    public es.svalero.leaguemanagement.model.Match addMatch(
        ...
        return (es.svalero.leaguemanagement.model.Match) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public es.svalero.leaguemanagement.model.Match getMatch(long matchId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { matchId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<es.svalero.leaguemanagement.model.Match> getMatchs(
        ...
        return (java.util.List<es.svalero.leaguemanagement.model.Match>) ClpSerializer.translateOutput(returnObj);
    }
