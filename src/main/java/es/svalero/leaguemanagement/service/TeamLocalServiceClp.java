...
public class TeamLocalServiceClp implements TeamLocalService {
    ...
    public es.svalero.leaguemanagement.model.Team addTeam(
        ...
        return (es.svalero.leaguemanagement.model.Team) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public es.svalero.leaguemanagement.model.Team getTeam(long teamId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { teamId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<es.svalero.leaguemanagement.model.Team> getTeams(
        ...
        return (java.util.List<es.svalero.leaguemanagement.model.Team>) ClpSerializer.translateOutput(returnObj);
    }
